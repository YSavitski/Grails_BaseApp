            ...
            <g:form url="[resource: customerInstance, action: 'updateProfile']" method="PUT">
                ...
                <fieldset class="form">
                    ...
                    <div class="fieldcontain ${hasErrors(bean: customerInstance, field: 'lastName', 'error')}">
                        <label for="firstName">
                            <g:message code="customer.firstName.label" default="Last Name"/>
                        </label>
                    ...
                    <div class="fieldcontain ${hasErrors(bean: customerInstance, field: 'phone', 'error')} required">
                        ...
                        <span class="property-value" aria-labelledby="phone-label">
                            %{--<g:fieldValue field="phone" bean="${customerInstance}"/>--}%
                            <g:phone334 phone="${customerInstance.phone}"/>
                        </span>
                    </div>
                    ...
                    <div class="fieldcontain ${hasErrors(bean: customerInstance, field: 'totalPoints', 'error')} required">
                        <span id="totalPoints-label" class="property-label">
                            <g:message code="customer.totalPoints.label" default="Total Points"/>
                        </span>
                        <span class="property-value" aria-labelledby="totalPoints-label">
                            <g:fieldValue field="totalPoints" bean="${customerInstance}"/>
                        </span>
                    </div>
                </fieldset>
